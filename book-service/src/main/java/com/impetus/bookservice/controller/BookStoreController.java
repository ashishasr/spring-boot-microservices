...
import com.impetus.bookservice.model.BookInfoForAuthor;
...
public class BookStoreController {
	...
	public BookInfoForAuthor getBookInfo(@PathVariable("authorId") Long authorId) {
		List<Book> booksListForAuthor = bookStoreService.getBooks(authorId);
		System.out.println("retrive books for Author ------- " + booksListForAuthor);
		BookInfoForAuthor bkForAuthor = new BookInfoForAuthor();
		bkForAuthor.setAuthorId(authorId);
		bkForAuthor.setBookList(booksListForAuthor);
		return bkForAuthor;
	}
