...
import com.impetus.bookservice.model.BookSummary;
...
public class BookStoreController {
	...
	public BookSummary getBookInfo(@PathVariable("authorId") Long authorId) {
		List<Book> bookList = bookStoreService.getBooks(authorId);
		System.out.println("retrive books for Author ------- " + bookList);
		BookSummary bookSummary = new BookSummary();
		bookSummary.setAuthorId(authorId);
		bookSummary.setBookList(bookList);
		return bookSummary;
	}
